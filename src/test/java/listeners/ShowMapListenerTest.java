...
public class ShowMapListenerTest {
	...
	public void 意図したQueryStringが取得できること() throws UnsupportedEncodingException {
		...
		new NonStrictExpectations() {
			{
				reader.getGoogleMapApiKey();result="";
				reader.getGoogleMapLanguage();result="jp";
				reader.getGoogleMapSensor();result="false";
				reader.getGoogleMapScale();result="1";
				reader.getGoogleMapZoom();result="16";
				reader.getGoogleMapSizeLength();result="500";
				reader.getGoogleMapSizeHeight();result="500";
			}
		};
